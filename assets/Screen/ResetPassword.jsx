                ...
                {({ handleChange, handleBlur, values, errors }) => (
                    <View className="p-4">
                        ...
                        <TouchableOpacity onPress={() => nav.navigate("LoginForm")}>
                            <Text className="border-none bg-gray-300 items-center text-[20px] text-center px-10 py-2 w-fit mx-auto rounded-full shadow-custom-black font-bold mt-7">Submit</Text>
                        </TouchableOpacity>
